...
module.exports = {
  // Tailwind v4: content is auto-detected, but kept for clarity
  content: [
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow:    { from: { boxShadow: '0 0 10px #7c3aed, 0 0 20px #7c3aed' }, to: { boxShadow: '0 0 20px #06b6d4, 0 0 40px #06b6d4' } },

...
interface ConfirmModalProps {
  isOpen: boolean;              // ✅ Wajib: boolean
  title: string;                // ✅ Wajib: string
  message: string;              // ✅ Wajib: string
  ...
  onConfirm: () => void;        // ✅ Wajib: function
  onCancel: () => void;         // ✅ Wajib: function
  isLoading?: boolean;          // ✅ Opsional: default false
}
